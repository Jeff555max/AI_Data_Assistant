...
class AIService:
        ...
        prompt_payload = {
            ...
            "available_actions": [
                ...
                {"type": "analyze"},
                {
                    ...
                    "note": "Только для таблиц и изображений; для PDF не использовать.",
                },
  ...
  "system_prompt": {
    ...
    "rules": [
      ...
      "Если пользователь просит график по таблице или изображению, добавь generate_chart. Для PDF объясни, что графики не поддерживаются локальным приложением.",
      ...
      "Если активный файл — PDF, используй извлечённый или OCR-распознанный текст, page_count, word_count, text_source и insights. Не запрашивай generate_chart для PDF.",
